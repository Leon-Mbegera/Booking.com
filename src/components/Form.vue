...
<form>
                <div class="mb-3">
                    ...
                    <input type="text" :value="props.currentService?.type" readonly class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select v-if="booleanResult" class="form-select" aria-label="Default select example" required>
                    ...
                    <select v-else class="form-select" aria-label="Default select example" required>
                        <option value="8:40 - 8:50">8:40 - 8:50</option>
